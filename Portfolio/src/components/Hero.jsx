...
function Hero() {
  return (
    <section className='flex flex-row md:flex-col text-white items-start justify-center bg-gradient-to-tr from-red-600 to-yellow-500 w-full overflow-hidden px-5 sm:px-20 border-b-4 border-stone-300'>
        <div className='flex-1 flex justify-center items-start flex-col lg:flex-row md:items-center'>
          <div className='flex-1 items-start my-3 md:my-28 px-12'>
          ...
          <img src={Image} className="rounded-3xl my-2 md:my-3"/>
        </div>
    </section>
  )
}
